      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center mb-24">
            ...
            <FadeIn>
                ...
                <h2 className="font-serif text-4xl md:text-5xl text-bone mb-8 leading-[1.1]">
                    ...
                    <span className="text-gold opacity-90">Define the Future</span> of Auditory Wellness.
                </h2>
                
                <p className="font-sans text-lg text-muted/90 leading-relaxed mb-8 font-light">
                    You have the expertise and the client results. We have the platform. 
                    <br/><br/>
                    We are assembling an <strong className="text-gold font-medium">Advisory Board</strong> of the world's leading experts to build the first comprehensive neuro-somatic protocol.
                </p>

                <div className="flex flex-col gap-4">
                    <p className="font-serif italic text-gold/80 text-xl">"The old standard of coping is broken. Help us build the new standard of calm."</p>
                </div>
            </FadeIn>
            ...
            <FadeIn delay={200} className="w-full">
                <div className="relative group rounded-xl bg-[#080a0c] border border-gold/30 p-10 hover:border-gold/50 transition-colors duration-500 shadow-2xl">
                    ...
                    <ul className="space-y-6 mb-10">
                        {[
                            { title: "High-Leverage Impact", desc: "Guide thousands of clients globally, not just 1:1." },
                            ...
                            { title: "Legacy", desc: "Help shift the global standard for auditory wellness." }
                        ].map((item, idx) => (
        ...
        <FadeIn delay={400} className="border-t border-white/5 pt-20">
            ...
            <div className="flex flex-wrap justify-center gap-4">
                {["Wellness Professionals", "TMJ & Tension Specialists", "Somatic Practitioners", "Nervous System Experts", "Holistic Health Coaches"].map((role) => (
